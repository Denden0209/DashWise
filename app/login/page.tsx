    ...
    <div style={{ minHeight:"100vh", background:C.bg, display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      <div style={{ width:"100%", maxWidth:420 }}>
        ...
        <div style={{ textAlign:"center", marginBottom:36 }}>
          ...
          <div style={{ fontSize:22, fontWeight:600, color:C.text, marginTop:20, marginBottom:5 }}>Welcome back</div>
        ...
        <div style={{ background:C.surface, border:`1px solid ${C.border}`, borderRadius:radius.xl, padding:32, boxShadow:shadow.md }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:20 }}>
            ...
            <span style={{ fontSize:12, color:C.text3 }}>or continue with email</span>
            <div style={{ flex:1, height:1, background:C.border }}/>
          </div>
          ...
          <form onSubmit={onEmail} style={{ display:"flex", flexDirection:"column", gap:16 }}>
            ...
            <div>
              ...
              <div style={{ position:"relative" }}>
                <input type={showP?"text":"password"} required value={pass} onChange={e=>setPass(e.target.value)} placeholder="Your password" style={{ ...input, paddingRight:56 }}/>
